...
<span class="postinfo"><?php esc_attr_e('By ' , 'bartleby' ); ?>
<?php the_author_posts_link(); ?> - <?php esc_attr_e('Published: ' , 'bartleby' ); ?><?php the_time('m/d/Y'); ?> - <?php esc_attr_e('Category: ' , 'bartleby' ); ?><?php the_category(', ') ?></span>
</section><!-- .byline -->
