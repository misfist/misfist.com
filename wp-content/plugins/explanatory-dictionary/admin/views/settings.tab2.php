...
<div class="wrap">
	...
	<div>
		<form action="" method="post" name="form0">
			<?php wp_nonce_field( Explanatory_Dictionary_Helpers::get_nonce('tab2'), 'tab2_nonce' ); ?>
			<?php do_settings_sections( Explanatory_Dictionary::$plugin_slug.'-tooltip-theme-settings' ); ?>
			<?php do_settings_sections( Explanatory_Dictionary::$plugin_slug.'-tooltip-title-settings' ); ?>
			<?php do_settings_sections( Explanatory_Dictionary::$plugin_slug.'-tooltip-content-settings' ); ?>
			<p class="submit">
				<?php submit_button( __( 'Update settings', 'explanatory-dictionary' ), 'primary', 'submit', false ); ?>
				<?php 
				submit_button( __( 'Reset settings', 'explanatory-dictionary' ), 'secondary', 'reset', false, 
					array (
