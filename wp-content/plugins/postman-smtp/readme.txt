...
> v1.7 adds support for the Mandrill and SendGrid APIs. Send mail to these services even if your host has blocked the standard SMTP ports. [Get it now](https://downloads.wordpress.org/plugin/postman-smtp.zip).
...
* Added a 'manage_postman_smtp' capability
